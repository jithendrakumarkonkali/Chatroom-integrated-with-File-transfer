...
class Server:
    ...
    def handle_client(self, client_socket):
        ...
        try:
            ...
            # If no outer exception, the while loop might have exited for other reasons
            # (e.g., graceful disconnect, or an error handled within the loop that caused a break).
            # In such cases, "Handler exit" is a reasonable default.
